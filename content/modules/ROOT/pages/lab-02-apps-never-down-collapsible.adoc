...
.Using the Web Console
====
In the top-left corner, click the project name and select *`{user}-lab`* from the list.
====
...
The *Current replicas* count climbs as CPU crosses the threshold. Slide back to *0%* when done.
====
