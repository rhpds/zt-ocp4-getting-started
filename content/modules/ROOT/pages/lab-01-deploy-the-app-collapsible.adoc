...
. In the *Application Name* field, change the value to `datasphere-ui`.
...
. Scroll down to *Advanced options*. Under *Show advanced Routing options*, *uncheck*
  *Create a Route* -- the API should not be publicly accessible.
. Click *Create*.
